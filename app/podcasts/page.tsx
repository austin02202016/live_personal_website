...
//         <h3 className="text-lg font-semibold group-hover:text-blue-600">{podcast.title}</h3>
//         <p className="text-sm text-gray-500">{podcast.description}</p>
//       </div>
//       <div className="p-6 border-t border-gray-100 flex justify-between items-center text-sm font-medium group-hover:text-blue-600">
//         <Link href={podcast.listenUrl} passHref>
//           <a className="flex items-center space-x-1 text-blue-600 hover:text-blue-500">
