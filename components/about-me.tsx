...
export function AboutMeSection() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gray-50 text-black font-sans"
      ref={ref}
    >
      <motion.div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <motion.h2
        ...
        <motion.div
          className="border border-gray-200 rounded-lg shadow-lg p-8 bg-white"
          initial={{ opacity: 0, y: -20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5 }}
        >
